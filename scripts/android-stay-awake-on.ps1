...
& $adb.Source devices
& $adb.Source shell settings put global stay_on_while_plugged_in 7
& $adb.Source shell input keyevent KEYCODE_WAKEUP
$value = & $adb.Source shell settings get global stay_on_while_plugged_in
Write-Host "stay_on_while_plugged_in=$value"
Write-Host "Phone screen will stay awake while plugged in via AC, USB, or wireless charging."
